...
class SignIn extends StatefulWidget {
  const SignIn({Key? key, required this.withoutAuth}) : super(key: key);

  final bool withoutAuth;

  @override
  SignInState createState() => new SignInState(withoutAuth: withoutAuth);
}

class SignInState extends State<SignIn> {
  bool? withoutAuth;

  SignInState({this.withoutAuth});
